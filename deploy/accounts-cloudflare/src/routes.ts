...
//   - `RETIRED_V1_PREFIX` ("/v1") — explicit fail-closed coverage for retired
//     Accounts paths and retained legacy Resource/Form/operator routes. It is
//     never an Accounts compatibility alias.
