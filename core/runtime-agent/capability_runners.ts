 ...
 * reached through host-specific globals directly in the library surface. The
 ...
 * module. Behavior is byte-for-byte identical to the direct
 * `runTarCommand` call: same args, same stdin piping, same
