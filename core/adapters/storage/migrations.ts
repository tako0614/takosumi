...
where allocation_kind <> 'scoped';`,
    ...
    {
      id: "deploy.install_config_runner_profile.normalize",
      version: 70,
      domain: "deploy",
      description:
        "Converge current InstallConfig rows from retired provider-specific runner profiles onto the provider-neutral OpenTofu default without rewriting historical Run records or operator-defined profiles.",
      sql: `update takosumi_install_configs
