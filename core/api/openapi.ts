...
> {
  return {
    ...
    CapsuleConfigurationRestoreRequest: {
      type: "object",
      required: [
        "kind",
        "bundleDigest",
      ...
      properties: {
        kind: { const: "takosumi.capsule-configuration-restore@v1" },
        bundleDigest: { type: "string", pattern: "^sha256:[0-9a-f]{64}$" },
        migrationId: { type: "string" },
        workspaceId: { type: "string" },
        sourceId: { type: "string" },
        sourceSnapshotId: { type: "string" },
        compatibilityCheckRunId: { type: "string" },
        compatibilityReportId: { type: "string" },
        capsule: {
          type: "object",
        ...
        configuration: {
          type: "object",
          required: ["variableMapping", "outputAllowlist", "policy"],
          properties: {
            modulePath: { type: "string" },
            sourceBuild: ref("SourceBuildConfig"),
            lifecycleActions: { type: "array", items: { type: "object" } },
            runnerId: { type: "string" },
            variableMapping: { type: "object", additionalProperties: true },
            variablePresentation: { type: "array", items: { type: "object" } },
            installExperience: { type: "object" },
            outputAllowlist: { type: "object", additionalProperties: true },
            policy: ref("PolicyConfig"),
            store: { type: "object" },
            interfaceBlueprints: {
              type: "array",
            ...
            requiredInterfaces: { type: "array", items: { type: "object" } },
            runtimeBindingMaterialization: { type: "object" },
          },
          additionalProperties: false,
        },
        providerBindings: {
          ...
          maxItems: 0,
          description:
            "Must be empty. Provider credentials and bindings are target-owned and never imported from a migration bundle.",
        },
      },
      additionalProperties: false,
    },
    CapsuleConfigurationRestoreResponse: {
      type: "object",
      required: ["restore", "links"],
      properties: {
        restore: {
          type: "object",
          required: [
