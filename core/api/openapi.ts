  ...
  return {
    ...
    FormAvailability: {
      ...
      properties: {
        ...
        executableReason: ref("FormAvailabilityReason"),
        activated: { type: "boolean" },
        availableToPrincipal: { type: "boolean" },
        availabilityReason: ref("FormAvailabilityReason"),
        operations: {
          type: "array",
          uniqueItems: true,
          items: {
    ...
    ListFormAvailabilityResponse: {
      type: "object",
      required: ["forms"],
      properties: {
        forms: { type: "array", items: ref("FormAvailability") },
        nextCursor: { type: "string", minLength: 1 },
      },
      additionalProperties: false,
    },
