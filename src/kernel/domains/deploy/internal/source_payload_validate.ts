// Validation phase for the reference deploy source payload.
//
...
//   - `validateReferenceDeploySourcePayload` (lint-only)
//   - `resolveReferenceDeploySourcePayload` (lint + override-merge return)
//   - `compileSourcePayloadToInternalDeploySpec` (lint then compile)
...
interface ValidateSourcePayloadOptions {
...
export function validateSourcePayloadShape(
  manifest: ReferenceDeploySourcePayload,
  options: ValidateSourcePayloadOptions = {},
): void {
