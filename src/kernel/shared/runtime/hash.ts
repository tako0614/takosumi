/**
 * Runtime-neutral SHA-256 helper used by kernel modules that must compile on
 ...
 * kernel from running on a bare V8 isolate. Web Crypto is available on every
 * runtime the kernel targets (Deno, Node 22+, Bun, Workers) and produces an
 ...
 * but documented separately so kernel call sites can express intent.
 */
