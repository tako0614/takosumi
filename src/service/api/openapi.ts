...
function createSchemas(): Record<string, Record<string, unknown>> {
  ...
  return {
    ...
    RunLogsResponse: jsonObject,
    RunEventsResponse: jsonObject,
    RunGroupResponse: jsonObject,
    ListActivityResponse: jsonObject,
    CreateBackupResponse: jsonObject,
    ListBackupsResponse: jsonObject,
    PatchSpaceRequest: jsonObject,
    DeploymentResponse: jsonObject,
