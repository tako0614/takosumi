 ...
 * bearer token to use. This is the ONLY thing the service needs from the
 ...
 *  - `TAKOSUMI_AGENT_TOKEN` — Bearer token shared between service and agent
 *
 * If both are unset, no providers are registered (the service still boots and
