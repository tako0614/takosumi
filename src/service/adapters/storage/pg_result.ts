/**
 * Wraps a raw `pg` Result-like object into the service's `SqlQueryResult`
 ...
 * what blocked service migrations in pre-fix builds. Centralising the
 * defensive normalisation here so every pg-backed wrapper (the service
