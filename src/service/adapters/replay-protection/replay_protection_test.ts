 ...
 * standing in for two Takosumi replicas — can race on the same row set just
...
test("SqlReplayProtectionStore: only one of two simulated Takosumi replicas wins the race", async () => {
