import type { SpaceRole } from "../../domains/space/mod.ts";
...
export interface RecordApprovalInput<T = unknown> extends ApprovalSubject<T> {
  ...
  readonly requiredRoles?: readonly SpaceRole[];
...
function missingRequiredRoles(
  actorRoles: readonly SpaceRole[],
  requiredRoles: readonly SpaceRole[],
): readonly SpaceRole[] {
