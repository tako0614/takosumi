...
export function runtimeContractRefFor(type: string): string {
  ...
  if (
    ...
    normalized ===
      "https://takosumi.com/reference/service/contracts/runtime/js-worker/v1"
  ) {
...
export const RESOURCE_CONTRACTS = [
  ...
  },
  {
    ...
    uri:
      "https://takosumi.com/reference/service/contracts/resource/key-value/v1",
  ...
  },
  {
    ...
    uri: "https://takosumi.com/reference/service/contracts/resource/secret/v1",
    aliases: ["secret"],
...
export function outputContractRefFor(type: string): string {
  ...
  if (
    ...
    normalized ===
      "https://takosumi.com/reference/service/contracts/output/mcp-server/v1"
  ) {
  ...
  if (
    ...
    normalized ===
      "https://takosumi.com/reference/service/contracts/output/topic/v1"
  ) {
