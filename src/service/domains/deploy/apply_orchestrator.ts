...
/** Stable operation-kind strings used by the orchestrator. Matches Space spec
 ...
 *
 *  Operation ordering follows Space spec § 13's apply pipeline:
...
/** Canonical idempotency key per Space spec § 13. Lifted to a free function
