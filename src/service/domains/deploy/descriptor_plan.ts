// descriptor_plan — descriptor-conformance metadata only.
//
...
// `descriptor_conformance_test.ts`.
...
const TAKOSUMI_CONTEXT_ID =
  "https://takosumi.com/reference/service/contexts/deploy.jsonld";
...
const COMPACT_DESCRIPTOR_RECORDS: readonly {
...
}[] = [
  {
    alias: "source.js-module@v1",
    path: "descriptors/contracts/source-js-module-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/source/js-module/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/runtime-input-oci-image-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/runtime-input/oci-image/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/authoring/composite-expansion-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/descriptors/authoring/composite-expansion/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/authoring/public-manifest-expansion-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/descriptors/authoring/public-manifest-expansion/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/composites/composite-serverless-with-postgres-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/composite/serverless-with-postgres/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/composites/composite-web-app-with-cdn-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/composite/web-app-with-cdn/v1",
    digest:
  ...
  },
  {
    ...
    context: {
      takosumi: "https://takosumi.com/reference/service/vocab/deploy#",
      id: "@id",
      type: "@type",
  ...
  },
  {
    alias: "interface.http@v1",
    path: "descriptors/contracts/interface-http-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/interface/http/v1",
    digest:
  ...
  },
  {
    alias: "interface.queue@v1",
    path: "descriptors/contracts/interface-queue-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/interface/queue/v1",
    digest:
  ...
  },
  {
    alias: "interface.tcp@v1",
    path: "descriptors/contracts/interface-tcp-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/interface/tcp/v1",
    digest:
  ...
  },
  {
    alias: "interface.udp@v1",
    path: "descriptors/contracts/interface-udp-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/interface/udp/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/output-http-endpoint-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/output/http-endpoint/v1",
    digest:
  ...
  },
  {
    alias: "output.mcp-server@v1",
    path: "descriptors/contracts/output-mcp-server-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/output/mcp-server/v1",
    digest:
  ...
  },
  {
    alias: "output.topic@v1",
    path: "descriptors/contracts/output-topic-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/output/topic/v1",
    digest:
  ...
  },
  {
    alias: "provider.aws.ecs-fargate@v1",
    path: "descriptors/providers/aws-ecs-fargate-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/aws/ecs-fargate/v1",
    digest:
  ...
  },
  {
    alias: "provider.aws.s3@v1",
    path: "descriptors/providers/aws-s3-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/aws/s3/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/providers/cloudflare-containers-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/providers/cloudflare/containers/v1",
    digest:
  ...
  },
  {
    alias: "provider.cloudflare.d1@v1",
    path: "descriptors/providers/cloudflare-d1-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/cloudflare/d1/v1",
    digest:
  ...
  },
  {
    alias: "provider.cloudflare.r2@v1",
    path: "descriptors/providers/cloudflare-r2-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/cloudflare/r2/v1",
    digest:
  ...
  },
  {
    alias: "provider.cloudflare.workers@v1",
    path: "descriptors/providers/cloudflare-workers-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/cloudflare/workers/v1",
    digest:
  ...
  },
  {
    alias: "provider.google.cloud-run@v1",
    path: "descriptors/providers/google-cloud-run-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/google/cloud-run/v1",
    digest:
  ...
  },
  {
    alias: "provider.kubernetes.generic@v1",
    path: "descriptors/providers/kubernetes-generic-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/kubernetes/generic/v1",
    digest:
  ...
  },
  {
    alias: "provider.neon.postgres@v1",
    path: "descriptors/providers/neon-postgres-v1.jsonld",
    id: "https://takosumi.com/reference/service/providers/neon/postgres/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/resource-analytics-engine-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/resource/analytics-engine/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/resource-durable-object-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/resource/durable-object/v1",
    digest:
  ...
  },
  {
    alias: "resource.key-value@v1",
    path: "descriptors/contracts/resource-key-value-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/resource/key-value/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/resource-object-store-s3-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/resource/object-store/s3/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/resource-queue-at-least-once-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/resource/queue/at-least-once/v1",
    digest:
  ...
  },
  {
    alias: "resource.secret@v1",
    path: "descriptors/contracts/resource-secret-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/resource/secret/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/resource-sql-postgres-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/resource/sql/postgres/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/resource-sql-sqlite-serverless-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/resource/sql/sqlite-serverless/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/resource-vector-index-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/resource/vector-index/v1",
    digest:
  ...
  },
  {
    alias: "runtime.js-worker@v1",
    path: "descriptors/contracts/runtime-js-worker-v1.jsonld",
    id: "https://takosumi.com/reference/service/contracts/runtime/js-worker/v1",
    digest:
  ...
  },
  {
    ...
    path: "descriptors/contracts/runtime-oci-container-v1.jsonld",
    id:
      "https://takosumi.com/reference/service/contracts/runtime/oci-container/v1",
    digest:
