 ...
 * desired-side concern produced an observation. The Deployment-centric space
 * collapses materialization records into `Deployment.conditions[]`, so this
 * remains a runtime-domain enum rather than a space type alias.
 */
 ...
 * The Deployment-centric space records observed provider state on the
