...
// Phase 4 (space simplification) acceptance tests for P0/P1/P2.
//
...
test("acceptance P0: provider failure does not mutate committed deployment", async () => {
  ...
  // observation is observed-side, never canonical (Space spec § 14).
...
// Wave J removed the service-side route projection, `desired.routes`,
...
// asserted on all of those at once. Deleted because the service no longer
