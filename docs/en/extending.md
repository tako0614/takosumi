...
| Import OpenTofu output | Operator distribution or `takosumi-plugins` importer |
...
OpenTofu providers should not be reimplemented as Takosumi plugins. Infrastructure that belongs in OpenTofu stays in
