...
| Import Terraform/OpenTofu output | Operator distribution or `takosumi-plugins` importer |
...
Terraform providers should not be reimplemented as Takosumi plugins. Infrastructure that belongs in Terraform stays in
