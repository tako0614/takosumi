...
- maintaining a second deployment, runtime-service, work, or resource ledger
  ...
  Shape records;
- placing official managed capacity, payment enforcement, price books, SLA, or
...
| Billing                        | Disabled/showback measurement ledger plus injected ShowbackRater / enforcement / quota ports                      | Operator rating policy; Cloud price book and payment extension                                                                               | No fixed price, plan-action weight, Stripe route/schema/env/client, official price book, or payment gate in OSS; zero/unrated must remain distinct from rated zero                                                                                     |
