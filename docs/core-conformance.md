...
| Resource Shape API                                                                  | partial        | Resource object routes and current default v1alpha1 shapes exist for EdgeWorker and AIEndpoint; ObjectBucket is not advertised by default because mature S3/R2/GCS providers and standard endpoints already exist. Events/refresh/import and full UI remain incomplete.       |
| Resource Shape contract types                                                       | partial        | `takosumi.dev/v1alpha1` exposes default public shapes for EdgeWorker and AIEndpoint. ObjectBucket remains a deferred/operator opt-in candidate, not a default provider replacement.                                                                                         |
