...
| CredentialRecipe                                                                                                                                                                  | conformant | `recipes/providers/*.yaml` now defines the built-in recipe catalog, including Cloudflare, AWS, GCP, S3-compatible, generic env, and common provider recipes; tests keep it in sync with runner/vault env-rule projections. |
