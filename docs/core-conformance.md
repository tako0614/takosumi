...
| Compatibility API framework                                                         | gap            | Required in OSS as a versioned profile framework. Specific profiles still need implementation and capabilities. Existing providers remain the default when they are enough.                                                                                                |
