...
- `connector:` is a reserved prefix. No implementation adapter or user AppSpec
  may mint identities under this prefix. Plan rejects AppSpecs that attempt to.
...
[Data Assets](./kind-registry.md#source-files-and-data-assets) を参照。
...
prepared source locator で決まる。provider implementation / connector binding
