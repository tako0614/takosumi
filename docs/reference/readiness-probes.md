...
response は spec-reserved であり、current HTTP output ではない。
...
## Spec-Reserved Observation propagation
...
## Spec-Reserved Failure propagation
