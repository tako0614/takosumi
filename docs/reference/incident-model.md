...
## Incident の定義 {#incident-definition}
...
## 自動検出トリガー {#auto-detection-triggers}
...
## 顧客影響クエリ {#customer-affecting-query}
...
## Observation / Drift / RevokeDebt モデル {#observation-drift--revokedebt-model}
...
### RevokeDebt {#revokedebt}

RevokeDebt は revoke または削除すべきだが cleanup できなかった生成 material を
記録する。

#### RevokeDebt レコードスキーマ {#revokedebt-record-schema}
...
#### ActivationSnapshot 伝播 {#activationsnapshot-propagation}
...
### Observation 保持 {#observation-retention}
...
#### RevokeDebt aging {#revokedebt-aging}
...
#### ObservationHistory ポリシー {#observationhistory-policy}
