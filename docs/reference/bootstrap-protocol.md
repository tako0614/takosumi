...
operator distribution が通常の TypeScript module として backend implementation subpath を import し、Takosumi service では reference adapter array (`plugins` option) に渡す。詳細は [Reference Adapter Loading](./plugin-loading.md)。
