...
> このページでわかること: tenant data export / Space deletion の wire-level API
> — export mode / 2-phase deletion / PII field redaction / audit 整合。
...
`TAKOSUMI_SPACE_DELETE_CONFIRM_TTL_SECONDS` (default 600) で operator
が設定する。
