...
| Operator implementation | runtime-agent runtime handler、inventory importer、backend adapter をどう提供するか。 |
...
| runtime-agent runtime handler implementation | operator distribution |
