...
- `docs/design/operator-boundaries.md` — kernel core が raw secret を持た ない
  trust 境界の rationale
- `docs/design/space-model.md` — partition の scope owner が Space である 理由と
  Space 削除時の partition lifecycle
- `docs/design/policy-risk-approval-error-model.md` — secret 関連 risk taxonomy
  と approval invalidation の interplay
