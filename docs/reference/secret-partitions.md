...
1:1 で分離される独立した暗号箱である。kernel core は partition の中身を永続化
...
- kernel core は raw secret value を永続化、cache、log しない。 decrypt は
...
- Deployment outputs、external publication evidence、Installation export bundle
