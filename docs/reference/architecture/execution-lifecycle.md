...
Preview は provider / resource / materialization side effect を持たず、 Installation / Deployment record も作りません。audit、telemetry、rate-limit accounting event は emit できます。
