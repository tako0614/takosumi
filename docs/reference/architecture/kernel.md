...
Deployment の recorded activation evidence を読み、hostname / path / resource
output から target resource を選びます。routing の詳細は
[Runtime routing](./runtime-routing.md) を参照してください。
