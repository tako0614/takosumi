...
| -------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------- | --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `takosumi-official-catalog-v1`   | portable kind schemas / native kind schemas / material kinds / projection examples | Takosumi official catalog, hosted at takosumi.com | [Takosumi Official Catalog](./catalog.md)                                               | `src/kinds/*/spec/kind.jsonld`; sibling `../takosumi-plugins/packages/kind-*/spec/kind.jsonld`; `spec/contexts/v1.jsonld`; `src/contract/catalog.ts` | `/kinds/v1/<name>`, `/kinds/v1/<name>.jsonld`, and `/contexts/v1.jsonld` |
...
`takosumi/src/kinds/*/spec/kind.jsonld` is the repository storage path for
...
| `takosumi-npm-package`         | npm subpath exports and dependency pins | package owners                                                     | `deno.json`, `src/all/*.ts`, `scripts/build-npm.ts`, `https://www.npmjs.com/package/@takosjp/takosumi`                         |
