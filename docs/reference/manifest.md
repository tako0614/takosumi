...
> validation / expand semantics / data model。 旧 4 file (`manifest-spec.md` /
> `manifest-validation.md` / `manifest-expand-semantics.md` /
> `architecture/manifest-model.md`) を 1 file に統合した正本。
