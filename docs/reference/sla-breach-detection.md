...
## SLA 次元 (v1 closed set) {#sla-dimensions-closed-v1-set}
...
## 閾値と違反判定 {#threshold-and-breach-criterion}
...
## 状態機械とヒステリシス {#state-machine-and-hysteresis}
...
## レポーティング surface {#reporting-surface}
