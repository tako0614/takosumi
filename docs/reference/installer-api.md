...
参照 API の形式は Cloud account layer API、self-hosted operator API、operator admin tooling のどれでもかまいません。route inventory、pagination、 authentication、redaction rule は operator profile が定義します。
