...
provisioning design surface. The current kernel HTTP router mounts
...
the stage-polling flow are design-reserved. :::
...
- `docs/design/catalog-release-adoption.md` — initialCatalogReleaseId adopt
  段階の semantics と再試行設計
