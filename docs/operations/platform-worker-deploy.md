...
| `TAKOSUMI_PROVIDER_REGISTRY_EVIDENCE_REF`                | ProviderConnection policy / CredentialRecipe / generic-env / internal resolver evidence. Env name is kept for deployed gate compatibility                            |
