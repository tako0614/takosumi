...
platform worker config に設定する。旧
`TAKOSUMI_ACCOUNTS_CLIENT_SERVICE_GRAPH_TOKEN_INTROSPECTION="enabled"` は互換
alias としてだけ残す。この flag は secret を持つ confidential client でだけ
