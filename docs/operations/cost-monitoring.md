...
| Managed resource usage             | Takosumi platform worker | Cloudflare managed-default meters joined to Space / Installation attribution        |
...
contract / dashboard reference を検証する状態が必要です。
