...
| unknown provider が runnable にならない | Compatibility Report の provider finding / missing Provider Connection                                     | CredentialRecipe / provider allowlist、ProviderConnection status、egress policy、custom runner availability を確認   |
