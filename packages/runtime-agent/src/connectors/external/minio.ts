/**
 * `MinioConnector` — object-store talking to a MinIO HTTP endpoint
...
export class MinioConnector implements Connector {
  readonly provider = "@takos/minio-object-store";
  ...
  constructor(opts: MinioConnectorOptions) {
    ...
    this.#secretBase = opts.secretRefBase ?? "secret://local-adapters/minio";
