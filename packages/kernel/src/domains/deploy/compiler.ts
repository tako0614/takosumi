...
function runtimeContractRefFor(type: string): string {
  ...
  if (
    ...
    normalized === "https://takos.dev/contracts/runtime/oci-container/v1"
  ) {
    return "runtime.oci-container@v1";
  }
  if (
    normalized === "runtime.js-worker@v1" ||
    normalized === "https://takos.dev/contracts/runtime/js-worker/v1"
  ) {
