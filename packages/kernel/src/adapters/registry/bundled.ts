...
const BUILT_IN_PACKAGE_SEEDS: readonly BuiltInPackageSeed[] = [
  ...
  {
    ref: "publication.route@v1",
    kind: "publication-contract-package",
    digest:
    ...
    body: {
      ...
      apiVersion: "v1",
      packageType: "publication-contract",
      publicationKinds: ["http-route"],
...
function providerSupportReport(
  ...
  return {
    ...
    interfaceContracts,
    routeProtocols,
    capabilityProfiles: ["data.json@v1", "publication.route@v1"],
    conformanceTier,
    limitations,
  };
}
