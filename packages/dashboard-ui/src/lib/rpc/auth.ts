/**
 * Auth flows for the RPC client: upstream OAuth (Google/GitHub) and passkey
 * registration (WebAuthn). The OAuth half is navigation-based; the passkey
 * half is request/response over {@link apiFetch}.
 */
