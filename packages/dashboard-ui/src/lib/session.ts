/**
 * Session state mirror. Source of truth is the `takosumi_session`
 * HttpOnly cookie set by the accounts-service on passkey complete /
 * OAuth callback (Agent 6 items 6, 7).
 *
