/**
 * CoreDNS `gateway@v1` KernelPlugin package.
 */
...
export interface CoreDnsGatewayProviderOptions {
...
export function coreDnsGatewayProvider(
  opts: CoreDnsGatewayProviderOptions = {},
): KernelPlugin {
  ...
  return {
    name: "@takos/coredns-gateway",
    version: "1.0.0",
    provides: [TAKOSUMI_REFERENCE_KIND_URIS.gateway],
...
function selectListener(
  ...
  if (!defaultHost) {
    throw new Error(
      "gateway listener requires spec.listeners.<name>.host or defaultHost",
    );
  }
