...
export type ExternalRouterKind = "caddy" | "traefik";

export interface ExternalRouterConfigWriter {
  write(
    input: ExternalRouterConfigWrite,
  ): Promise<ExternalRouterConfigWriteResult>;
}

export interface ExternalRouterConfigWrite {
...
export interface ExternalRouterConfigWriteResult {
  readonly path?: string;
  readonly revision?: string;
}

export interface ExternalRouterConfigAdapterOptions {
  readonly writer: ExternalRouterConfigWriter;
  readonly kind?: ExternalRouterKind;
  readonly path?: string;
...
export class ExternalRouterConfigAdapter implements router.RouterConfigPort {
  readonly #writer: ExternalRouterConfigWriter;
  readonly #kind: ExternalRouterKind;
  readonly #path?: string;
  readonly #renderer: router.RouterConfigRenderer;
  ...
  constructor(options: ExternalRouterConfigAdapterOptions) {
