...
Deno.test("JSR publish dry-run package list includes only publishable packages", () => {
  assert.deepEqual(
    ...
    [
      ...
      "packages/plugins",
      "packages/plugin-web-service-docker-compose",
      "packages/plugin-web-service-systemd",
      "packages/plugin-object-store-minio",
      "packages/plugin-object-store-filesystem",
      "packages/plugin-postgres-docker",
      "packages/plugin-gateway-coredns",
      "packages/cloudflare-providers",
      "packages/deno-deploy-providers",
      "packages/aws-providers",
      "packages/gcp-providers",
      "packages/kubernetes-providers",
      "packages/kernel",
      "packages/cli",
      "packages/all",
    ],
