...
const billingAccountColumns = {
  ...
  stripe_default_payment_method_id:
    billingAccounts.stripeDefaultPaymentMethodId,
...
function billingAccountValues(record: BillingAccountRecord) {
  return {
    ...
    stripeDefaultPaymentMethodId: record.stripeDefaultPaymentMethodId ?? null,
...
function billingAccountUpdateSet(
  ...
  return {
    ...
    stripeDefaultPaymentMethodId: values.stripeDefaultPaymentMethodId,
