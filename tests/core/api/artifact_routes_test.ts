...
import { MemoryObjectStorage } from "../../../core/adapters/object-storage/memory.ts";
import { InMemoryTakosumiDeploymentRecordStore } from "../../../core/domains/deploy-records/deployment_record_store.ts";
import {
  registerArtifactRoutes,
  TAKOSUMI_ARTIFACT_MAX_BYTES_DEFAULT,
  TAKOSUMI_ARTIFACTS_BUCKET,
  TAKOSUMI_ARTIFACTS_PATH,
} from "../../../core/api/artifact_routes.ts";
