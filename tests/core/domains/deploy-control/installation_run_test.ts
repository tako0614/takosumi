...
test("Gateway resource recurring metering records period-scoped UsageEvents idempotently", async () => {
  ...
  expect(await store.listUsageEvents("space_test")).toEqual([
    expect.objectContaining({
      ...
      source: "resource_meter",
      idempotencyKey:
        "provider-runtime:space_test:2026-06-07T00:00:00.000Z:2026-06-07T01:00:00.000Z:cf-worker:inst_fixture:inst_fixture:gateway_compute",
    }),
    expect.objectContaining({
      kind: "gateway_storage_gb_hour",
      quantity: 2.5,
      ...
      source: "resource_meter",
      idempotencyKey:
        "provider-runtime:space_test:2026-06-07T00:00:00.000Z:2026-06-07T01:00:00.000Z:r2:inst_fixture:inst_fixture:gateway_storage_gb_hour",
    }),
  ]);
  await expect(
