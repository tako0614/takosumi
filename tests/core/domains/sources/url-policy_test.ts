...
} from "../../../../core/domains/sources/url-policy.ts";
...
const ALLOWED: readonly AllowCase[] = [
  ...
  {
    url: "https://gitlab.example.com:8443/g/r.git",
    scheme: "https",
    host: "gitlab.example.com",
  },
  {
    url: "https://Codeberg.org/Acme/Repo",
    scheme: "https",
    host: "codeberg.org",
  },
  {
    url: "ssh://git@github.com/acme/repo.git",
    scheme: "ssh",
    host: "github.com",
  },
  {
    url: "ssh://git@git.example.org:2222/acme/repo",
    scheme: "ssh",
...
const DENIED: readonly DenyCase[] = [
  ...
  {
    url: "https://user:pass@github.com/acme/repo",
    reason: "embedded_credentials",
  },
  { url: "https://token@github.com/acme/repo", reason: "embedded_credentials" },
  {
    url: "ssh://git:secret@github.com/acme/repo",
    reason: "embedded_credentials",
  },
  // Parser differential hardening: WHATWG sees host github.com, but git/libcurl
  // may dial the host after the backslash/userinfo boundary.
  { url: "https://github.com\\@10.0.0.1/acme/repo.git", reason: "malformed" },
  { url: "ssh://git@github.com\\@10.0.0.1/acme/repo.git", reason: "malformed" },
