...
test("accounts migrate dry-run prints ordered migration plan", async () => {
  ...
  expect(plan.migrations.length).toEqual(44);
  ...
  expect(plan.migrations[42].name).toEqual(
    "043_oidc_client_activation_digest.sql",
  );
  expect(plan.migrations[43].name).toEqual(
