...
export const ja = {
  ...
  "cloudResources.usage.title": "使用量",
  "cloudResources.usage.subtitle": "現在の Workspace の使用量です。",
  "cloudResources.usage.noWorkspace":
    "Workspace を選ぶと使用量が表示されます。",
  "cloudResources.usage.monthCredits": "今月の使用量",
  "cloudResources.usage.gatewayCredits": "Gateway 使用量",
  "cloudResources.usage.balance": "利用可能クレジット",
  "cloudResources.usage.kind.runnerMinute": "Runner",
  "cloudResources.usage.kind.operation": "操作",
