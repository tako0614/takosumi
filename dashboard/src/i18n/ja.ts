...
export const ja = {
  ...
  "new.store.searchPlaceholder": "サービス名、提供元、種類で探す",
  "new.store.count": "{count} 件",
  "new.store.empty.title": "追加できるサービスがありません",
  "new.store.empty.message": "リンクから追加できます。",
  "new.store.searchEmpty.title": "見つかりませんでした",
  "new.store.searchEmpty.message": "別の言葉で探すか、リンクから追加できます。",
  "new.store.searchEmpty.clear": "検索を消す",
  "new.catalog.kind.worker": "Webアプリ",
  "new.catalog.kind.site": "Webサイト",
  "new.catalog.kind.storage": "ストレージ",
  "new.catalog.add": "追加",
  "new.manualCard.title": "リンクから追加",
  "new.manualCard.body": "インストールリンクを貼ります。",
