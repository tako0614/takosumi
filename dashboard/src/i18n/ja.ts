...
export const ja = {
  ...
  "app.source.title": "開発者向け取得元",
  "app.source.name": "名前",
  "app.source.url": "リポジトリ URL",
  "app.source.refPath": "バージョン / フォルダ",
  "app.source.status": "取得状態",
  "app.source.loading": "開発者向け情報を読み込み中です。",
  ...
  "app.bindings.title": "サービスの接続先",
  "app.bindings.subtitle":
    "このサービスが使う外部サービスです。通常は変更不要です。",
  "app.bindings.none": "外部サービス接続は紐づいていません。",
  "app.bindings.editAdvanced": "開発者向けの接続設定",
  ...
  "run.connections.reviewBody":
    "続行する前に確認が必要な外部サービス接続があります。認証情報の値は表示しません。",
  ...
  "run.audit.title": "サポート用の活動記録",
  "run.audit.empty": "活動記録はありません。",

  // --- add flow (/new) -------------------------------------------------------
  "new.title": "サービスを追加",
  "new.subtitle": "おすすめから選ぶか、自分のアプリを追加します。",
  "new.store.aria": "おすすめサービス",
  "new.store.title": "おすすめサービス",
  "new.catalog.select": "これを追加",
  "new.advancedImport.open": "自分のアプリを使う",
  "new.advancedImport.close": "おすすめに戻る",
  "new.advancedImport.title": "自分のアプリを追加",
  "new.advancedImport.subtitle":
    "インストールリンクを貼り付けます。開発者向け設定ではリポジトリ URL も使えます。",
  ...
  "new.git.url": "インストールリンクまたはリポジトリ URL",
  "new.git.advanced": "開発者向け取得元設定",
  "new.git.ref": "バージョン",
  "new.git.path": "フォルダ",
  "new.sourceAccess.title": "非公開リポジトリのアクセス",
  "new.sourceAccess.body":
    "公開リポジトリなら認証情報は不要です。非公開の取得元では、読み取り専用の HTTPS token を保存するか、保存済みの取得元アクセスを選んでください。",
  "new.sourceAccess.mode": "リポジトリアクセス",
  ...
  "new.vars.errorUnsafeName":
    "「{name}」はリンク/入力値として渡せません。secret は外部サービス接続を使ってください。",
  ...
  "new.deeplink.invalidBody":
    "安全な HTTPS 取得元が含まれていないか、ブラウザで開けない取得元情報が含まれています。例から選ぶか、リポジトリ URL を手動で貼り付けてください。",
  ...
  "new.providers.title": "利用する外部サービス",
  ...
  "new.providers.operatorMissingBody":
    "このサービスを追加するには外部サービス接続が必要です。",
  "new.providers.operatorMissingNext":
    "接続画面を開くか、ワークスペース管理者に接続の追加を依頼してください。",
  "new.step.technical": "サポート用の進行状況",
  ...
  "new.error.sourceFetchFailed":
    "アプリの内容を取得できませんでした。URL、バージョン、フォルダ、または非公開リポジトリの接続を確認してください。詳細: {message}",
  ...
  // --- connections -------------------------------------------------------------
  "conn.subtitle":
    "このワークスペースがデプロイ先として使う外部サービスを接続します。保存した secret は二度と表示しません。",
  ...
  "conn.add.title": "外部サービスを接続",
  "conn.add.open": "接続を追加",
  "conn.add.close": "閉じる",
  "conn.add.provider": "外部サービス",
  ...
  "conn.guided.openProvider": "{provider} の token 画面を開く",
  "conn.guided.oauth": "{provider} で自動接続",
  "conn.guided.stepsSummary": "手動 token 設定",
  ...
  "conn.advanced.summary": "開発者向けフィールド",
  "conn.advanced.register": "開発者向けフィールドを保存",
  "conn.register": "接続を保存",
  ...
  "notif.supportSummary": "サポート履歴",
  "notif.viewRaw": "サポートログを開く →",
  ...
  // --- activity -------------------------------------------------------------------
  "activity.title": "サポートログ",
  "activity.subtitle":
    "トラブルシュート用にサービスやアカウントの出来事を新しい順に記録します。",
  "activity.details": "開発者向けイベントデータ",
