...
export const en: Record<keyof typeof ja, string> = {
  ...
  "nav.add": "Add",
  "nav.runs": "Updates",
  "nav.connections": "Provider access",
  "nav.billing": "Billing",
  ...
  "app.bindings.title": "Provider access",
  "app.bindings.subtitle":
    "Provider credentials this service can use. Usually no change is needed.",
  "app.bindings.none": "No provider access is linked.",
  "app.bindings.editAdvanced": "Change provider access mapping",
  "app.bindings.add": "Add provider access",
  "app.bindings.providerPlaceholder": "Provider",
  "app.bindings.aliasPlaceholder": "Target name (optional)",
  "app.bindings.selectConnection": "Select provider access",
  ...
  "app.bindings.errorConnection":
    "Select ready provider access for {provider}.",
  ...
  "run.connections.title": "Provider access",
  "run.connections.reviewTitle": "Provider access review needed",
  "run.connections.reviewBody":
    "One or more provider access settings need attention before this can continue. Private values are not shown.",
  ...
  "run.connections.empty": "No provider access review info.",
  ...
  "new.vars.errorUnsafeName":
    "“{name}” cannot be passed as a link/input value. Use provider access for private values.",
  ...
  "new.compat.patchHelp":
    "Review the items above. Some issues require app changes, while others can be resolved by setting up the required provider access.",
  ...
  "new.providers.title": "Provider access to use",
  "new.providers.alias": "Target: {alias}",
  "new.providers.selectConnection": "Select provider access",
  "new.providers.errorConnection":
    "Select ready provider access for {provider}.",
  "new.providers.missingTitle": "Provider access is required",
  "new.providers.missingBody": "Set up provider access to continue.",
  "new.providers.setupMissing": "Set up required provider access",
  "new.providers.returnNote":
    "After you connect provider access, you return here to finish adding.",
  ...
  // --- connections -------------------------------------------------------------
  "conn.subtitle": "Connect provider access this team can use for hosting.",
  "conn.providerConnections.title": "Provider access",
  ...
  "conn.return.subtitle":
    "Save provider access, then return to finish adding the service.",
  ...
  "conn.add.title": "Connect provider access",
  "conn.add.open": "Add provider access",
  ...
  "conn.custom.back": "Use guided provider",
  ...
  "conn.empty.title": "No provider access yet",
  "conn.empty.message": "Add access when a service needs provider credentials.",
  "conn.test": "Check access",
  "conn.testing": "Checking...",
  "conn.test.notReady": "The account is not ready yet (status: {status}).",
  "conn.remove.confirmTitle": "Delete provider access",
  ...
  "notif.event.connCreated": "Added provider access “{provider}”",
  "notif.event.connCreatedGeneric": "Added provider access",
  "notif.event.connRevoked": "Provider access “{provider}” was revoked",
  "notif.event.connRevokedGeneric": "Provider access was revoked",
