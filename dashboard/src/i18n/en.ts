...
export const en: Record<keyof typeof ja, string> = {
  ...
  "app.bindings.title": "Cloud accounts",
  "app.bindings.subtitle":
    "Cloud accounts this service can use. Usually no change is needed.",
  ...
  "run.connections.reviewTitle": "Cloud account review needed",
  "run.connections.reviewBody":
    "One or more cloud accounts need attention before this can continue. Private values are not shown.",
  "run.connections.provider": "Cloud service",
  "run.connections.connection": "Cloud account",
  "run.connections.status": "Status",
  "run.connections.statusResolved": "Ready",
  "run.connections.statusMissing": "Account needed",
  ...
  "new.vars.errorUnsafeName":
    "“{name}” cannot be passed as a link/input value. Use cloud accounts for private values.",
  ...
  "new.compat.issue.providerCredentials.detail":
    "Do not keep API tokens or account IDs in code. Remove those values, then connect the {provider} account so Takosumi can pass them only while deploying.",
  "new.compat.issue.providerLift.message":
    "The {provider} account settings can be handled safely once private values are removed.",
  "new.compat.issue.lockfile.message":
    "Pinned cloud-service information is included. After private values are removed, the pinned services will be reviewed during add.",
  ...
  "new.providers.title": "Cloud accounts to use",
  ...
  "conn.return.subtitle":
    "Save the cloud account, then return to finish adding the service.",
  ...
  "conn.add.title": "Connect a cloud account",
  "conn.add.open": "Add cloud account",
  "conn.add.close": "Close",
  "conn.add.provider": "Cloud service",
  "conn.add.genericEnvOption": "Custom service",
  "conn.add.optionalSettings": "Name this account",
  "conn.add.displayName": "Account name",
  "conn.add.displayNamePlaceholder": "Work Cloudflare",
  ...
  "conn.custom.summary": "Other cloud service",
  "conn.custom.body":
    "Use this only when you need a service that is not listed.",
  "conn.custom.use": "Add custom service",
  "conn.custom.back": "Back to cloud services",
  ...
  "conn.genericEnv.providerRequired": "Enter a custom service name.",
  ...
  "conn.error.invalidProvider": "Invalid cloud service.",
  ...
  "conn.remove.confirmTitle": "Delete cloud account",
  ...
  "notif.event.connCreated": "Added cloud account “{provider}”",
  "notif.event.connCreatedGeneric": "Added a cloud account",
  "notif.event.connRevoked": "Cloud account “{provider}” was revoked",
  "notif.event.connRevokedGeneric": "A cloud account was revoked",
