...
export const en: Record<keyof typeof ja, string> = {
  ...
  "app.bindings.editAdvanced": "Change connection mapping",
  ...
  "run.resources.title": "Detailed change list",
  ...
  "run.details.title": "Detailed information",
  ...
  "new.progress.title": "Checking whether this can be added",
  ...
  "new.compat.patchHelp":
    "Review the items above. Some issues require app changes, while others can be resolved by setting up the required external service connection.",
  ...
  "new.compat.issue.providerCredentials.detail":
    "Do not keep API tokens or account IDs in code. Remove the credential values, then set up the {provider} connection so they can be passed only while the run executes.",
  "new.compat.issue.providerLift.message":
    "The {provider} connection settings can be handled safely once credentials are removed.",
  "new.compat.issue.lockfile.message":
    "Pinned external-service information is included. After credentials are removed, the pinned services will be reviewed during add.",
  ...
  "new.providers.title": "Connections to use",
  ...
  "new.providers.operatorMissingTitle": "A required connection is missing",
  ...
  "new.providers.operatorMissingNext":
    "Add the connection or ask an admin to add it.",
  ...
  "conn.add.genericEnvOption": "Service not listed",
  ...
  "conn.custom.summary": "Services not listed",
  "conn.custom.body":
    "Only use this when the service you need is not listed above.",
  "conn.custom.use": "Add detailed connection",
  "conn.custom.back": "Back to listed services",
  "conn.advanced.summary": "Detailed connection information",
  "conn.advanced.register": "Save detailed connection information",
  "conn.register": "Save connection",
  "conn.registering": "Registering...",
  "conn.genericEnv.providerName": "Service name",
  "conn.genericEnv.envName": "Item name",
  ...
  "notif.supportSummary": "Detailed record",
  "notif.viewRaw": "Open record →",
  ...
  "activity.details": "Detailed event data",
  ...
  "account.profile.subject": "Account ID",
  ...
  "account.session.details": "Detailed sign-in information",
