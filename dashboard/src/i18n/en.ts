...
export const en: Record<keyof typeof ja, string> = {
  ...
  "run.connections.title": "Hosting access",
  "run.connections.reviewTitle": "Hosting access review needed",
  "run.connections.reviewBody":
    "One or more hosting access entries need attention before this can continue. Private values are not shown.",
  ...
  // --- connections -------------------------------------------------------------
  "conn.subtitle":
    "Connect the cloud accounts and access keys this team can use when hosting services.",
  "conn.providerConnections.title": "Hosting access",
  ...
  "conn.return.subtitle":
    "Save hosting access, then return to finish adding the service.",
  ...
  "conn.add.title": "Add hosting access",
  "conn.add.open": "Add hosting access",
  ...
  "conn.remove.confirmTitle": "Delete hosting access",
  ...
  "cloudResources.keys.create": "Create API key",
  ...
  "cloudResources.usage.title": "Usage",
  "cloudResources.usage.subtitle": "Usage for the current Workspace.",
  "cloudResources.usage.noWorkspace": "Select a Workspace to show usage.",
  "cloudResources.usage.monthCredits": "This month",
  "cloudResources.usage.gatewayCredits": "Gateway usage",
  "cloudResources.usage.balance": "Available credits",
  "cloudResources.usage.kind.runnerMinute": "Runner",
  "cloudResources.usage.kind.operation": "Operation",
  "cloudResources.usage.kind.compute": "Gateway compute",
  "cloudResources.usage.kind.storage": "Gateway storage",
  "cloudResources.usage.kind.artifactStorage": "Artifact storage",
