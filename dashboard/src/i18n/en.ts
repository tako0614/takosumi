...
export const en: Record<keyof typeof ja, string> = {
  ...
  "new.store.searchPlaceholder": "Search by service, source, or type",
  "new.store.count": "{count} items",
  "new.store.empty.title": "No services are available",
  "new.store.empty.message": "You can add one from a link.",
  "new.store.searchEmpty.title": "No matches",
  ...
  "new.manualCard.body": "Paste an install link.",
