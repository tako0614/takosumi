...
export const en: Record<keyof typeof ja, string> = {
  ...
  "app.source.title": "Developer source",
  "app.source.name": "Name",
  "app.source.url": "Repository URL",
  "app.source.refPath": "Version / folder",
  "app.source.status": "Fetch status",
  "app.source.loading": "Loading developer info.",
  ...
  "app.bindings.title": "Service connections",
  "app.bindings.subtitle":
    "External services this service uses. Usually no change is needed.",
  "app.bindings.none": "No external service connection is linked.",
  "app.bindings.editAdvanced": "Developer connection mapping",
  ...
  "run.resources.kicker": "Developer details",
  "run.resources.title": "OpenTofu resource details",
  "run.resources.count": "{n} changes",
  "run.resources.more": "{n} more low-level changes are included in this plan.",
  ...
  "run.connections.reviewBody":
    "One or more external service connections need attention before this can continue. Credential values are not shown.",
  ...
  "run.audit.title": "Support activity record",
  "run.audit.empty": "No activity records.",

  // --- add flow (/new) -------------------------------------------------------
  "new.title": "Add service",
  "new.subtitle": "Choose a starter or add your own app.",
  "new.store.aria": "Recommended services",
  "new.store.title": "Recommended services",
  "new.catalog.select": "Add this",
  "new.advancedImport.open": "Use your own app",
  "new.advancedImport.close": "Back to recommendations",
  "new.advancedImport.title": "Add your own app",
  "new.advancedImport.subtitle":
    "Paste an install link. Repository URLs are available for developer setup.",
  ...
  "new.git.url": "Install link or repository URL",
  "new.git.advanced": "Developer source settings",
  "new.git.ref": "Version",
  "new.git.path": "Folder",
  "new.sourceAccess.title": "Private repository access",
  ...
  "new.sourceAccess.mode": "Repository access",
  ...
  "new.vars.projectName": "Internal name prefix",
  ...
  "new.vars.errorUnsafeName":
    "“{name}” cannot be passed as a link/input value. Use external service connections for secrets.",
  ...
  "new.deeplink.invalidBody":
    "The link was missing a safe HTTPS source, or it included source material that cannot be opened in the browser. Choose an example or paste the repository URL manually.",
  ...
  "new.compat.details": "Developer check details",
  ...
  "new.providers.title": "External service to use",
  ...
  "new.providers.operatorMissingBody":
    "This service needs an external service connection before it can be added.",
  "new.providers.operatorMissingNext":
    "Open connections or ask a workspace admin to add one.",
  "new.step.technical": "Support progress",
  ...
  "new.error.sourceFetchFailed":
    "Takosumi could not fetch the app contents. Check the URL, version, folder, or private-repository connection. Detail: {message}",
  ...
  // --- connections -------------------------------------------------------------
  "conn.subtitle":
    "Connect services this workspace can deploy to. Saved secrets are never shown again.",
  ...
  "conn.add.title": "Connect an external service",
  "conn.add.open": "Add connection",
  "conn.add.close": "Close",
  "conn.add.provider": "External service",
  ...
  "conn.guided.openProvider": "Open {provider} token page",
  "conn.guided.oauth": "Connect automatically with {provider}",
  "conn.guided.stepsSummary": "Manual token setup",
  "conn.guided.pasteLabel": "Token",
  "conn.guided.pastePlaceholder": "Paste the token here",
  "conn.guided.connect": "Save manual connection",
  ...
  "conn.advanced.summary": "Developer fields",
  "conn.advanced.register": "Save developer fields",
  ...
  "notif.supportSummary": "Support history",
  "notif.viewRaw": "Open support log →",
  ...
  // --- activity -------------------------------------------------------------------
  "activity.title": "Support log",
  "activity.subtitle":
    "Service and account events for troubleshooting, newest first.",
  "activity.details": "Developer event data",
