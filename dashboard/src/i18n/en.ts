...
export const en: Record<keyof typeof ja, string> = {
  ...
  "conn.custom.summary": "Other OpenTofu provider",
  "conn.custom.body": "Save access values for a service that is not listed.",
  ...
  "conn.genericEnv.envName": "Environment variable",
