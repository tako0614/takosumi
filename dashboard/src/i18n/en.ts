...
export const en: Record<keyof typeof ja, string> = {
  ...
  "nav.add": "Add",
  "nav.runs": "Updates",
  "nav.connections": "Cloud connections",
  "nav.billing": "Billing",
  ...
  "app.bindings.title": "Cloud connections",
  "app.bindings.subtitle":
    "Cloud account credentials this service can use. Usually no change is needed.",
  "app.bindings.none": "No cloud connection is linked.",
  "app.bindings.editAdvanced": "Change cloud connection mapping",
  "app.bindings.add": "Add cloud connection",
  "app.bindings.providerPlaceholder": "Provider",
  "app.bindings.aliasPlaceholder": "Target name (optional)",
  "app.bindings.selectConnection": "Select cloud connection",
  ...
  "app.bindings.errorConnection":
    "Select a ready cloud connection for {provider}.",
  ...
  "run.connections.title": "Cloud connections",
  "run.connections.reviewTitle": "Cloud connection review needed",
  "run.connections.reviewBody":
    "One or more cloud connections need attention before this can continue. Private values are not shown.",
  ...
  "run.connections.empty": "No cloud connection review info.",
  ...
  "new.vars.errorUnsafeName":
    "“{name}” cannot be passed as a link/input value. Use cloud connections for private values.",
  ...
  "new.compat.patchHelp":
    "Review the items above. Some issues require app changes, while others can be resolved by setting up the required cloud connection.",
  ...
  "new.providers.title": "Cloud connection to use",
  "new.providers.alias": "Target: {alias}",
  "new.providers.selectConnection": "Select cloud connection",
  "new.providers.errorConnection":
    "Select a ready cloud connection for {provider}.",
  "new.providers.missingTitle": "Cloud connection is required",
  "new.providers.missingBody": "Set up a cloud connection to continue.",
  "new.providers.setupMissing": "Set up required cloud connection",
  "new.providers.returnNote":
    "After you save the cloud connection, you return here to finish adding.",
  ...
  // --- connections -------------------------------------------------------------
  "conn.subtitle": "Connect cloud accounts this team can use for hosting.",
  "conn.providerConnections.title": "Cloud connections",
  ...
  "conn.return.subtitle":
    "Save a cloud connection, then return to finish adding the service.",
  ...
  "conn.add.title": "Add cloud connection",
  "conn.add.open": "Add cloud connection",
  "conn.add.close": "Close",
  "conn.add.provider": "Provider",
  "conn.add.genericEnvOption": "Any OpenTofu provider",
  "conn.add.optionalSettings": "Name this account",
  "conn.add.displayName": "Account name",
  ...
  "conn.guided.connect": "Save account",
  ...
  "conn.empty.title": "No cloud connections yet",
  "conn.empty.message": "Add one when a service needs cloud credentials.",
  "conn.test": "Check access",
  "conn.testing": "Checking...",
  "conn.test.notReady": "The account is not ready yet (status: {status}).",
  "conn.remove.confirmTitle": "Delete cloud connection",
  ...
  "notif.event.connCreated": "Added cloud connection “{provider}”",
  "notif.event.connCreatedGeneric": "Added cloud connection",
  "notif.event.connRevoked": "Cloud connection “{provider}” was revoked",
  "notif.event.connRevokedGeneric": "Cloud connection was revoked",
