...
const RunGroupView = lazy(() => import("./views/control/ControlRunGroupView.tsx"));
const GraphView = lazy(() => import("./views/control/ControlGraphView.tsx"));
const ActivityView = lazy(() => import("./views/control/ControlActivityView.tsx"));
