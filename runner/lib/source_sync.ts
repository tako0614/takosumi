...
// implicit dashboard default `main` does not exist, fall back to remote HEAD so
// older repositories whose default branch is `master` still install without
// requiring Takosumi metadata.
