...
4. `packages/kind-*/spec/kind.jsonld` → overlaid onto `website/.output/public/kinds/v1/` (= official type catalog descriptors, with extensionless and `.jsonld` variants).
