    ...
    <header class="nav" classList={{ "is-scrolled": scrolled() }}>
      <div class="nav-inner container">
        ...
        <div class="nav-actions">
          <a class="nav-icon" href="https://github.com/tako0614/takosumi" rel="noopener" aria-label="GitHub">
          ...
          <ThemeToggle />
          <a class="btn btn-primary nav-cta" href="/docs/getting-started/quickstart" rel="external">
            Quickstart
          </a>
        </div>
      </div>
