...
/**
 * Compatibility path for product hosts that still own a native-token
 * registration route. New mobile clients use the product-neutral
 * Notification Pusher contract instead; this is not a Takosumi-managed push
 * service or Resource Shape.
 */
